...
;smh0125
;21 February 2023
;Description - Adds different indexs from input into the first 16bits of multiple registers and adds shift
;I did not use any external sourses for this project
...
.code
	main proc
		...
		mov hey, EAX
		mov EBX, hey
		mov ah, 07fh; add 1st value from input into register
